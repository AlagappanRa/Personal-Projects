...
print("")
print(" rotation 7x5")
print_matrix(make_rotation_matrix(7,5))
...
def make_diamond_matrix(m,n):
    ...
    for k in range(rg):
        if n % 2 != 0:
            second_part = [i for i in range(start_number, end_number - 1)][::-1]
        else:
            second_part = [i for i in range(start_number, end_number)][::-1]
            
        next_row = [i for i in range(start_number, end_number)] + second_part
        start_number += 1
        end_number += 1
